...
import AuthButton from "../../AuthButton"; // plasmic-import: 2RW8fY2h_hyT/component
...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: 6hwPnp28x1ML/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: 3RgDNFs14zJl/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: 1Q6T6uMW_-HT/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__r7I0F)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <ph.DataCtxReader>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__lYXp)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___7G3Lh)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <ph.DataCtxReader>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox___7WKyg)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__vBd33)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,

      ...
      >
        {(() => {
          ...
          return (
            ...
            >
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__oK1LR)}
                label={"Email"}
                name={"email"}
              >
                <AntdInput
              ...
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__iqE4R)}
                label={"Password"}
                name={"password"}
              >
                <AntdPassword
              ...
              >
                <div
                  className={classNames(
                    ...
                    sty.text___84DJb,
                    {
                      [sty.textmode_signUp___84DJbbc6ZL]: hasVariant(
                        $state,
                        "mode",
                        "signUp"
                      )

      ...
      >
        {(() => {
          ...
          return (
            ...
            >
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__ymj5G)}
                label={"Email"}
                name={"email"}
              >
                <AntdInput
              ...
              <FormItemWrapper
                className={classNames("__wab_instance", sty.formField__urQr)}
                label={"Password"}
                name={"password"}
              >
                <AntdPassword
              ...
              >
                <div
                  className={classNames(
                    ...
                    sty.text__z8Ehq,
                    {
                      [sty.textmode_signUp__z8Ehqbc6ZL]: hasVariant(
                        $state,
                        "mode",
                        "signUp"
                      )
